...
class ProductApi {
   ...
   * @param {object} params 
   */
  getAllProducts(params = { _page: AppConstants.DEFAULT_PAGE, _limit: AppConstants.DEFAULT_LIMIT }) {
   ...
   */
  getById(postId) {
    const url = `${AppConstants.API_URL}/${this.resourceName}?categoryId=${postId}`;
